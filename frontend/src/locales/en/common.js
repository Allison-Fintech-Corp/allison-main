const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Allison can work with many LLM providers. This will be the service which handles chatting.",
    },
    userSetup: {
      title: "User Setup",
    ...
    survey: {
      title: "Welcome to Allison",
      description: "Help us make Allison built for your needs. Optional.",

      email: "What's your email?",
      useCase: "What will you use Allison for?",
      useCaseWork: "For work",
      useCasePersonal: "For personal use",
      useCaseOther: "Other",
      comment: "How did you hear about Allison?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description:
        "Create your first workspace and get started with Allison.",
    },
  },
  common: {
  ...
  chat_window: {
    welcome: "Welcome to Allison, your CRA compliance assistant.",
    get_started: "Get started by uploading documents or asking questions about CRA compliance.",
    get_started_default: "To get started",
    upload: "upload documents",
    or: "or",
    attachments_processing: "Attachments are processing. Please wait...",
    send_chat: "ask about compliance.",
