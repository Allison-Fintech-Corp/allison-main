...
const AllisonIcon = "/allison_favicon.png"; // Use public Allison square icon
...
export const VECTOR_DB_PRIVACY = {
  ...
  lancedb: {
    name: "LanceDB",
    description: [
      "Your vectors and document text are stored privately on this instance of Allison",
    ],
    logo: LanceDbLogo,
  },
};
...
export const EMBEDDING_ENGINE_PRIVACY = {
  native: {
    name: "Allison Embedder",
    description: [
      "Your document text is embedded privately on this instance of Allison",
    ],
    logo: AllisonIcon,
  },
  openai: {
...
export const FALLBACKS = {
  LLM: (provider) => ({
    name: "Unknown",
    description: [
      `"${provider}" has no known data handling policy defined in Allison`,
    ],
    logo: AllisonIcon,
  }),
  EMBEDDING: (provider) => ({
